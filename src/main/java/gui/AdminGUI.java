...
public class AdminGUI extends JFrame {
	...
	public AdminGUI(String username) {
		...
		this.setTitle(ResourceBundle.getBundle(etiketak).getString("AdminGUI.Admin"));
		this.setSize(495, 290);

		jLabelSelectOption = new JLabel(ResourceBundle.getBundle(etiketak).getString("AdminGUI.Admin"));
		...
		jButtonDeskontu.setText(ResourceBundle.getBundle(etiketak).getString("AdminGUI.Deskontua"));
		...
		jButtonkude.setText(ResourceBundle.getBundle(etiketak).getString("AdminGUI.Kudea"));

		jButtonEzabatu = new JButton();
		jButtonEzabatu.setText(ResourceBundle.getBundle(etiketak).getString("AdminGUI.Ezab"));
		...
		jButtonItxi.setText(ResourceBundle.getBundle(etiketak).getString("EgoeraGUI.Close"));
